...
import skillroad from "../assets/skillroad.jpg";
import HSR from "../assets/office.jpg";
import mainroad from "../assets/27mainroad.jpg";
...
function OurSpace() {
  return (
    <>
      ...
      <Grid2 container spacing={4} justifyContent={{lg:"normal", md:"normal",sm:"center", xs:"center"}}>
        {spaces.map((space, index) => (
          <Grid2 key={index} size={{ lg: 4, md: 6, sm: 12 }}>
            <Card
              cardTitle={space.name}
              dayPassPrice={space.day_pass_price}
              discount={space.day_pass_discounts_percentage[10].value}
